...
export class AuthService {
  ...
  public createUserContacts(data:any){
    return this.httpClient.post<any>(`${this.REST_API_SERVER}/v1/clients/confidant-info`, data);
  }

  public getUserContacts(){
    return this.httpClient.get<any>(`${this.REST_API_SERVER}/v1/clients/confidant-info`);
  }
