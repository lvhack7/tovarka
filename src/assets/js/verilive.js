const urlVeri = "https://services.verigram.ai:8443/verilive/verilive"
...
async function runVerilive() {
  ...
  verilive.init(urlVeri, apiKey, config)
    .then(() => {
      onStartButtonClick()
    })
    .catch((error) => {
...
function onStartButtonClick() {
  ...
  localStorage.setItem('current_session', JSON.stringify(token));
}
